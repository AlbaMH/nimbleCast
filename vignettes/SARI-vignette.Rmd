...
covid_plot_output <- covid_plot+
  geom_line(data=as_tibble(sari_output_parallel$x_corrected$x_corrected_95quantiles), aes(x=dates[t],y=`50%`), alpha=0.5)+
  geom_ribbon(data=as_tibble(sari_output_parallel$x_corrected$x_corrected_95quantiles), aes(x=dates[t],ymin=`2.5%`, ymax=`97.5%`), alpha=0.5)
covid_plot_output
